...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\PPEPharBundle\\Entity'))), 'PPEPharBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('PPEPharBundle' => 'PPEPharBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_be80d7593f653863a677453fabcbc10763722a01ff318208f343199c9bb50654');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('saly.moubarak@gmail.com');
        $a->setPassword('sqmcxr05');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\PPEPharBundle/Resources/views'), 'PPEPhar');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a83ab6ad39a25b68ccf758b1cb9812a49768121e');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5723e762aba886.56601603')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PPEPharBundle' => 'PPEPharBundle\\PPEPharBundle',
            ...
            'mailer_user' => 'saly.moubarak@gmail.com',
            'mailer_password' => 'sqmcxr05',
            'secret' => 'a83ab6ad39a25b68ccf758b1cb9812a49768121e',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'a83ab6ad39a25b68ccf758b1cb9812a49768121e',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'saly.moubarak@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'sqmcxr05',
